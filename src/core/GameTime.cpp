...
namespace GameTime
{
    ...
    template<>
    std::chrono::system_clock::time_point GetGameTimePoint<std::chrono::system_clock>()
    {
        return GetGameTimeSystemPoint();
    }

    template<>
    std::chrono::steady_clock::time_point GetGameTimePoint<std::chrono::steady_clock>()
    {
